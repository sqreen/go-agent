// Package repl implements a REPL (read-eval-print loop) for sqjs.
package repl
...
func DebuggerHandler(vm *sqjs.Otto) {
...
func RunWithPrelude(vm *sqjs.Otto, prelude string) error {
	return RunWithOptions(vm, Options{
		Prelude: prelude,
	})
}
...
func RunWithPromptAndPrelude(vm *sqjs.Otto, prompt, prelude string) error {
	return RunWithOptions(vm, Options{
		Prompt:  prompt,
		Prelude: prelude,
	})
...
func RunWithOptions(vm *sqjs.Otto, options Options) error {
