...
func init() {
	...
	helpers.MustAttachTracer("main.(s).m0", func(*s) (func(), error)(nil))
	helpers.MustAttachTracer("main.(s).m1", func(*s, *int) (func(), error)(nil))
	helpers.MustAttachTracer("main.(*s).m2", func(**s) (func(), error)(nil))
	helpers.MustAttachTracer("main.(*s).m3", func(**s) (func(), error)(nil))
	helpers.MustAttachTracer("main.(s).m4", func(*s) (func(), error)(nil))
	helpers.MustAttachTracer("main.(s).m5", func(*s, *int) (func(), error)(nil))
	helpers.MustAttachTracer("main.(s).m6", func(*s, *int) (func(), error)(nil))
}
