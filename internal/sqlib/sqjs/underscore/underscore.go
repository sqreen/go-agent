...
Package underscore contains the source for the JavaScript utility-belt library.
	...
	import (
		_ "github.com/sqreen/go-agent/internal/sqlib/sqjs/underscore"
	)
...
To prevent this behavior, you can do the following:
	...
	import (
		"github.com/sqreen/go-agent/internal/sqlib/sqjs/underscore"
	)
...
import (
	"github.com/sqreen/go-agent/internal/sqlib/sqjs/registry"
)
