...
func TestDate_parse(t *testing.T) {
	tt(t, func() {
		...
		test(`Date.parse("1970-01-16T14:36:56+00:00")`, int64(1348616000))

		test(`Date.parse("1970-01-16T14:36:56.313+00:00")`, int64(1348616313))

		test(`Date.parse("1970-01-16T14:36:56.000")`, int64(1348616000))
